...
meta2 = read.table(file.path(Sys.getenv('DBDIR'), file.metadata_pub), sep = '\t', header = TRUE)[,c('Sample_ID', 'RNA_Sample_ID', 'ERCC_Mix', 'Barcode', 'RNA_A260.A280_Ratio', 'RNA_RIN' , 'Library_Con_ng.ul')]
...
fields_with_description = which(colnames(allMeta) %in% names(METAFIELD_DESCRIPTION))
